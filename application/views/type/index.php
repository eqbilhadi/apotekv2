    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Data Tipe</h3>
                        <div class="card-tools">
    ...
    $(function() {
        table.DataTable({
            ...
            "language": {
                ...
                "emptyTable": "Tidak ada data tipe",
                "zeroRecords": "Data tipe tidak ditemukan",
                "info": "Menampilkan _START_ sampai _END_ dari _TOTAL_ total tipe",
                "infoFiltered": "(terfilter dari _MAX_ total tipe)",
                "infoEmpty": "Menampilkan 0 sampai 0 dari 0 total tipe",
                "paginate": {
                    "first": "Awal",
                    "last": "Akhir",
                ...
                "search": "Cari:",
                "lengthMenu": "Lihat _MENU_ data tipe",
                "searchPlaceholder": "Nama tipe"
            }
        });
        ...
        $.ajax({
            ...
            success: function(response) {
                if (type == 'edit') {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'Yakin hapus data tipe ini?',
                        showCancelButton: true,
                        confirmButtonText: 'Ya',
                        cancelButtonText: `Tidak`,
                    }).then((result) => {
                        if (result.isConfirmed) {
                            deleteData(response.id_type);
