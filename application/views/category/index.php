...
<script>
    ...
    $(function() {
        table.DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= site_url('category/getCategory') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                    "targets": [0, -1],
            ...
            "language": {
                ...
                "info": "Menampilkan _START_ sampai _END_ dari _TOTAL_ total kategori",
                "infoFiltered": "(terfilter dari _MAX_ total kategori)",
                "infoEmpty": "Menampilkan 0 sampai 0 dari 0 total kategori",
                "paginate": {
                    "first": "Awal",
                    "last": "Akhir",
                ...
                "search": "Cari:",
                "lengthMenu": "Lihat _MENU_ data kategori",
        ...
        $.ajax({
            ...
            success: function(response) {
                if (type == 'edit') {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'Yakin hapus data kategori ini?',
                        showCancelButton: true,
                        confirmButtonText: 'Ya',
                        cancelButtonText: `Tidak`,
                    }).then((result) => {
                        if (result.isConfirmed) {
                            deleteData(response.id_category);
