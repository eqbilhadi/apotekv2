                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" id="btnAdd"><i class="fas fa-plus-circle"></i> Tambah Transaksi</button>
                        </div>
                    </div>
                    <!-- /.card-header -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title cardUbah-title">Tambah Data Pembelian</h3>
                        <div class="card-tools">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group select-wrapper">
                                ...
                                <input type="hidden" name="id_transaksi_d" id="id_transaksi_d">
                                <div class="pelapis">
...
<div class="modal fade" id="modal-export">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Export Data Pembelian</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        <a href="<?=base_url('stokin/exportpdf')?>" target="_blank" class="btn btn-danger btn-sm" style="width: 100%;"><i class="fas fa-file-pdf mr-1"></i> PDF</a>
                    </div>
                    <div class="col-lg-6">
                    <a href="<?= base_url('stokin/excel') ?>" class="btn btn-success btn-sm" style="width: 100%;"><i class="fas fa-file-excel mr-1"></i> Excel</a>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modalAkhiriTransaksi">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="#" id="formAkhiriTransaksi" method="POST">
                <div class="modal-body">
                    <div class="row">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary btn-akhiri-transaksi" style="width: 100%;" onclick="akhiritransaksi()"><i class="fas fa-save"></i> Simpan Transaksi</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $(function() {
        ...
        tabletransaksilist.DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= site_url('stokin/getTransaksiList') ?>",
                "type": "POST",
                "data": function(d) {
    ...
    function save() {
        resetValidation()
        if (saveData == 'add') {
            url = "<?= site_url('stokin/addBarang') ?>"
        } else if (saveData == 'edit') {
            url = "<?= site_url('stokin/updateBarang') ?>"
        }
    ...
    function akhiritransaksi() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= site_url('stokin/akhiriTransaksi') ?>",
    ...
    function byidBarang(id, type) {
        ...
        $.ajax({
            type: "GET",
            url: "<?= site_url('stokin/byidBarang/') ?>" + id,
            dataType: "JSON",
    ...
    function deleteDataBarang(id) {
        $.ajax({
            type: "post",
            url: "<?= site_url('stokin/deleteBarang/') ?>",
            data: {
                id_transaksi_d: id,
            },
            dataType: "json",
    ...
    function cari() {
        ...
        tableCariItem.DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= site_url('stokin/getItem') ?>",
                "type": "POST",
                "data": function(d) {
                    d.tipe = tipeModal
                    d.kategori = kategoriModal
                    d.lokasi = null
                    return d
                }
            },
