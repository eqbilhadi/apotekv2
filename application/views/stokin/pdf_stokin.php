...
<body>
    ...
    <table width='70%' style='margin-bottom:14px; font-size:10pt;'>
        ...
        <tr>
            <td width='10%'>Total Jumlah Item </td>
            <td width='1%' style="text-align: right;">: </td>
            <td width='30%' style="text-align: left;"><?= $total_jml; ?></td>
        </tr>
        <tr>
            <td width='10%'>Total Jumlah Pembelian</td>
            <td width='1%' style="text-align: right;">: </td>
    ...
    <table class="table1" style="font-size:10pt;">
        <tr>
            ...
            <th style="text-align: left; width: 30%">Nomor Faktur</th>
        ...
        foreach ($data as $value) {
            if ($value->is_draft != 1) { ?>
                <tr>
                    ...
                    <td style="text-align: left;"><?= $value->jml ?></td>
