                                ...
                                <div class="card-body">
                                    ...
                                    <table style="width: 100%;">
                                        <tr class="text-center">
                                            <td style="vertical-align: top;">
                                                <button type="button" class="btn btn-sm btn-warning btn-cancel" onclick="cancel()" style="width: 90%;"><i class="fas fa-times"></i> Batal</button>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-sm btn-success btn-process" onclick="bayar()" style="width: 90%;"><i class="fas fa-cash-register"></i> Bayar</button>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="#" id="formBayar" method="POST">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary btn-bayar" style="width: 100%;" onclick="processPembayaran()"><i class="fas fa-cash-register"></i> Bayar</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function pilih(id_item, nm_brg, saldo) {
        Swal.fire({
            ...
            } else if (parseInt(jml) <= 0) {
                Toast.fire({
                    icon: 'warning',
                    title: 'Harus lebih dari angka 0'
                })
