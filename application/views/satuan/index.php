    ...
    $(function() {
        table.DataTable({
            ...
            "language": {
                ...
                "zeroRecords": "Data satuan tidak ditemukan",
                "info": "Menampilkan _START_ sampai _END_ dari _TOTAL_ total satuan",
                "infoFiltered": "(terfilter dari _MAX_ total satuan)",
                "infoEmpty": "Menampilkan 0 sampai 0 dari 0 total satuan",
                "paginate": {
                    "first": "Awal",
                    "last": "Akhir",
                ...
                "search": "Cari:",
                "lengthMenu": "Lihat _MENU_ data satuan",
                "searchPlaceholder": "Nama satuan"
            }
        });
        ...
        $.ajax({
            ...
            success: function(response) {
                if (type == 'edit') {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'Yakin hapus data satuan ini?',
                        showCancelButton: true,
                        confirmButtonText: 'Ya',
                        cancelButtonText: `Tidak`,
                    }).then((result) => {
                        if (result.isConfirmed) {
                            deleteData(response.id_satuan);
